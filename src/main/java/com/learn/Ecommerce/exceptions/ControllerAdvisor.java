...
public class ControllerAdvisor extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleUserNotFoundException(UserNotFoundException ex, WebRequest request) {
		...
		Map<String, Object> body = new LinkedHashMap<>();
		body.put("timestamp", LocalDateTime.now());
		body.put("message", "user is not found with this email or password");

		return new ResponseEntity<>(body, HttpStatus.NOT_FOUND);
	}
	
	@ExceptionHandler(NullUserObjectException.class)
	public ResponseEntity<Object> handleNullUserObjectException(NullUserObjectException ex, WebRequest request) {

		Map<String, Object> body = new LinkedHashMap<>();
		body.put("timestamp", LocalDateTime.now());
		body.put("message", "user object should not be empty");
